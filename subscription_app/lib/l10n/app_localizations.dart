...
class L10n {
  static const Map<String, Map<String, String>> _strings = {
    'en': {
      ...
      'connecting_stream': 'Connecting…',
      'video_unavailable': 'Video unavailable',
      'stream_unavailable': 'Stream not found or already ended',
      'chat': 'Chat',
    ...
    'ru': {
      ...
      'connecting_stream': 'Подключение…',
      'video_unavailable': 'Видео недоступно',
      'stream_unavailable': 'Трансляция не найдена или уже завершена',
      'chat': 'Чат',
      'no_messages_yet': 'Сообщений пока нет',
      'write_message': 'Написать сообщение…',
      'login_to_chat': 'Войдите, чтобы писать',
      'anonymous': 'Аноним',
      'back': 'Назад',
    ...
    'kk': {
      ...
      'connecting_stream': 'Қосылуда…',
      'video_unavailable': 'Бейне қолжетімсіз',
      'stream_unavailable': 'Трансляция табылмады немесе аяқталды',
      'chat': 'Чат',
      'no_messages_yet': 'Әзірге хабарлама жоқ',
      'write_message': 'Хабарлама жазу…',
      'login_to_chat': 'Жазу үшін кіріңіз',
      'anonymous': 'Аноним',
      'back': 'Артқа',
